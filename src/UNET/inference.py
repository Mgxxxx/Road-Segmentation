...
from src.config import DATA_PATH, MODEL_PATH, DEVICE, TEST_IMAGES_PATH
...
def test_predictions(model_pth):
    ...
    for img in tqdm(test_loader):
        ...
        pred_path = f'data/test_mask/test_mask_{i}'
        if not os.path.exists(pred_path):
            os.makedirs(pred_path)
        
        pred_path = os.path.join(pred_path, f'test_mask_{i}.png')
